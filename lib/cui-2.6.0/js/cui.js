...
$templateCache.put("__cui/match-multiple.tpl.html"," <span class=ui-select-match><li class=\"ui-select-match-item cui-select-search-choice\" ng-repeat=\"$item in $select.selected\" ng-class=\"{\'cui-select-search-choice-focus\':$selectMultiple.activeMatchIndex === $index, \'cui-select-locked\':$select.isLocked(this, $index)}\" ui-select-sort=$select.selected><span uis-transclude-append></span> <a href=javascript:; class=\"ui-select-match-close cui-select-search-choice-close\" ng-click=$selectMultiple.removeChoice($index) tabindex=-1>x</a></li></span>");
$templateCache.put("__cui/match.tpl.html"," <a class=\"cui-select-choice ui-select-match\" ng-class=\"{\'cui-select-default\': $select.isEmpty()}\" ng-click=$select.toggle($event) aria-label=\"{{ $select.baseTitle }} select\"><span ng-show=$select.isEmpty() class=cui-select-chosen>{{$select.placeholder}}</span> <span ng-hide=$select.isEmpty() class=cui-select-chosen ng-transclude></span> <abbr ng-if=\"$select.allowClear && !$select.isEmpty()\" class=cui-select-search-choice-close ng-click=$select.clear($event)></abbr> <span class=\"cui-select-arrow ui-select-toggle\"><b></b></span></a>");
$templateCache.put("__cui/select-multiple.tpl.html","<div class=\"ui-select-container ui-select-multiple cui-select cui-select-container cui-select-container-multi\" ng-class=\"{\'cui-select-container-active cui-select-dropdown-open open\': $select.open,\n                \'cui-select-container-disabled\': $select.disabled}\"><ul class=cui-select-choices><span class=ui-select-match></span><li class=cui-select-search-field><input type=text autocomplete=off autocorrect=off autocapitalize=off spellcheck role=combobox aria-expanded=true aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-label=\"{{ $select.baseTitle }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"cui-select-input ui-select-search\" placeholder={{$selectMultiple.getPlaceholder()}} ng-disabled=$select.disabled ng-hide=$select.disabled ng-model=$select.search ng-click=$select.activate() style=\"width: 34px\" ondrop=\"return false\"></li></ul><div class=\"cui-select-drop cui-select-with-searchbox cui-select-drop-active\" ng-class=\"{\'cui-select-display-none\': !$select.open}\"><div class=ui-select-choices></div></div></div>");
$templateCache.put("__cui/select.tpl.html","<div class=\"ui-select-container cui-select cui-select-container\" ng-class=\"{\'cui-select-container-active cui-select-dropdown-open open\': $select.open,\n                \'cui-select-container-disabled\': $select.disabled,\n                \'cui-select-container-active\': $select.focus,\n                \'cui-select-allowclear\': $select.allowClear && !$select.isEmpty()}\"><div class=ui-select-match></div><div class=\"cui-select-drop cui-select-with-searchbox cui-select-drop-active\" ng-class=\"{\'cui-select-display-none\': !$select.open}\"><div class=cui-select-search ng-show=$select.searchEnabled><input type=text autocomplete=off autocorrect=off autocapitalize=off spellcheck role=combobox aria-expanded=true aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-label=\"{{ $select.baseTitle }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"ui-select-search cui-select-input\" ng-model=$select.search></div><div class=ui-select-choices></div></div></div>");
